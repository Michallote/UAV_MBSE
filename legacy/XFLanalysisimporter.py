...
class OpPoint:
    ...
    def read_file(self,OP_POINT_FILE):
        ...
        intervals = [[sep[i]+1,sep[i+1]] for i in range(len(sep)-1) if any([(line.rstrip('\n') in table_names) for line in lines[sep[i]:sep[i+1]]])]
...
if __name__ == "__main__":
    ...
    # create the factory
    OP = OpPoint()
    OP.read_file(OP_POINT_FILE='E:/Documentos/Thesis - Master/Master/XFLR5 exports/OpPointMainWing_a=0.00_v=16.00ms.txt')
