...
propdir = (
    "E:\Documentos\Aero Design\ILSP\Propellers\PERFILES_WEB\PERFILES2\PER3_11x6.dat"
)
...
prop_avanzada = df_propeller.loc[
    (df_propeller["EnginePower"] < 1000) & (df_propeller["V"] < 23)
]
...
ax1.set(xlabel="V", ylabel="RPM", zlabel="Efficiency")
