...
from PyQt5.QtWidgets import QApplication, QTabWidget, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QLineEdit, QFileDialog, QGridLayout

class MainWindow(QTabWidget):
    
    def __init__(self, title='UAD Aircraft Developer Tool', window_size=(600, 400), *args, **kwargs):
        ...
        tab1_layout.addWidget(self.exit_button, alignment=Qt.AlignRight | Qt.AlignBottom)
        ...
        self.hbox, self.button1, self.line1 = self.create_bilateral(button_text = "File Explorer (XML)",
        ...
        #Create text and button side by side
        self.hbox2, self.button2, self.line2 = self.create_bilateral(button_text = "Set Airfoil Folder",
        ...
        #Create text and button side by side
        self.hbox3, self.button3, self.line3 = self.create_bilateral(button_text = "Set Working Directory",
    ...
    def create_bilateral(self, button_text = "Click me to enable tabs 2 and 3", function = lambda : None, line_text = 'Insert XML file path' ):
...
def get_file(file_path = None, extension = None):
    ...
    filters = {'.txt':"Text Files (*.txt);;All Files (*)",
    ...
    if file_path is None or not os.path.exists(file_path):
        ...
        file_path, _ = QFileDialog.getOpenFileName(None,"Select a file", "",filter_str, options=options)
        return file_path
    else:
